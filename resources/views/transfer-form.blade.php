        ...
        <div class="flex-1 ml-6 mt-5 mr-10 ">
            ...
            <div class="flex items-center justify-center p-12">
                ...
                <div class="mx-auto rounded-md p-10"
                    ...
                    <form action="{{ route('save-transfer', $file->id) }} " method="post" enctype="multipart/form-data">
                        @csrf
                        <div>
                            <p class="text-xl font-extrabold flex justify-center items-center text-white">Select New
                                Destiantion</p>
                        </div>
                        <div class="mb-5">
                            <label for="new_country" class="mb-2 block text-sm font-medium text-[#f2f2f7]">
                                Country
                            </label>
