...
<body class="antialiased ">
    <div
        class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gradient-to-r from-green-200 to-blue-500 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        @if (Route::has('login'))
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white bg-fuchsia-900">
                                Documentation</h2>
        ...
        <div>
            <p class=" bg-gradient-to-r from-rose-700 to-pink-600 text-white font-extrabold text-5xl px-4 py-2 shadow-xl rounded-md">Delice Files
                Tracker </p>
        </div>
